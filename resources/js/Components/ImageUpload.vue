...
<template>
    <div>
        ...
        <label 
            for="image"
            class="block rounded-md mt-1 bg-slate-300 
            h-[140px] overflow-hidden cursor-pointer border-slate-300 
            border relative"
        ...
        >
            ...
            />
            <button 
                class="absolute top-2 right-2 bg-white/75 
        ...
        <input 
            @input="imageSelected" type="file" name="image" id="image" hidden>
    </div>
</template>
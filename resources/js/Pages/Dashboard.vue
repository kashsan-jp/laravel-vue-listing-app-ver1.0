...
<template>
            ...
            <div class="mb-6">
                ...
                <div class="flex items-center justify-between mb^4">
                    ...
                    <div class="flex items-center gap-4 text-xs">
                        <p>
                            Approved 
                            <i class="fa-solid fa-circle-check text-green-500"></i></p>
                        <p>
                            Pending approval
                            <i class="fa-solid fa-circle-xmark text-red-500"></i></p>
                    </div>
                </div>
                ...
                >
                    <thead
                        class="bg-slate-300 text-xs uppercase
                    ...
                    <tbody>
                        ...
                        >
                            ...
                            <td 
                                class="w-1/4 py-3 pr-3 text-right
                                text-indigo-500"
                            >
                            <Link 
                            ...
                            <td 
                                class="w-1/5 py-3 pr-3 text-right
                                text-indigo-500"
                            >
                            <Link
    ...
    <div v-else>
        Due to violation our terms, your account has been suspended,
        Please contact us

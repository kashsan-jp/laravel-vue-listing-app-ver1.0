...
const toggleApprove = (listing) => { 
    ...
    let msg = listing.approved 
        ...
        if(confirm(msg)) {
            ...
            router.put(route('admin.a pprove', listing.id))
        }
};
...
<template>
    ...
    <div class="mb-6">
        ...
        <div class="flex items-center justify-between"> 
            ...
            <Link 
                class="
                    px-2 py-[6px] rounded-md bg-indigo-500 
        ...
        >
            ...
            <label 
                for="showDisapproved"
                class="block text-sm for-medium text-slate-700
    ...
    <table class="bg-white dark:bg-slate-800 w-full rounded-lg
        ...
        <tbody class="divided-y divide-slate-300 divide-dashed">
